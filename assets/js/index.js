...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "C:\\Xiaomi\\haowai01\\components\\index\\index.vue"
	  if (!module.hot.data) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-691fefda&file=index.vue&scoped=true!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-691fefda&file=index.vue&scoped=true!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./index.vue");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "\r\n\t.loading[_v-691fefda]{\r\n            width: 5rem;\r\n            left: 2.5rem;\r\n            height: 30px;\r\n            margin: 0 auto;\r\n            margin-top:40px;\r\n            text-align: center;\r\n            position: absolute;\r\n            top: 6rem;\r\n            z-index: 0;\r\n        }\r\n        .loading span[_v-691fefda]{\r\n            display: inline-block;\r\n            width: 30px;\r\n            height: 100%;\r\n            margin-right: 10px;\r\n            background: #be0000;\r\n            -webkit-animation: load 1.04s ease infinite;\r\n        }\r\n        .loading label[_v-691fefda]{\r\n        \tdisplay: block;\r\n        \tcolor:#be0000;\r\n        }\r\n        .loading span[_v-691fefda]:last-child{\r\n            margin-right: 0px; \r\n        }\r\n        .loading span[_v-691fefda]:nth-child(1){\r\n            -webkit-animation-delay:0.2s;\r\n        }\r\n        .loading span[_v-691fefda]:nth-child(2){\r\n            -webkit-animation-delay:0.4s;\r\n        }\r\n        .loading span[_v-691fefda]:nth-child(3){\r\n            -webkit-animation-delay:0.6s;\r\n        }\r\n        .loading span[_v-691fefda]:nth-child(4){\r\n            -webkit-animation-delay:0.8s;\r\n        }\r\n        .loading span[_v-691fefda]:nth-child(5){\r\n            -webkit-animation-delay:1s;\r\n        }\r\n", ""]);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "C:\\Xiaomi\\haowai01\\components\\toast\\toast.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-985d9c78&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!../../node_modules/vue-loader/lib/style-rewriter.js?id=_v-985d9c78&file=toast.vue!../../node_modules/vue-loader/lib/selector.js?type=style&index=0!./toast.vue");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ (function(module, exports) {
	...
	module.exports = "\n\t<div :style=\"{background:createImg? 'url('+imgs.bg+') no-repeat center 100%':'transparent',backgroundSize:'200% 200%'}\" class=\"lt-full zmiti-index-main-ui \" :class=\"{'show':show}\" _v-691fefda=\"\">\n\n\t\t<transition name=\"zmiti-scale\" @after-enter=\"afterEnter\" _v-691fefda=\"\">\n\t\t    <div ref=\"createimgs\" :style=\"{background: 'url('+imgs.imgBg+') no-repeat center top',backgroundSize:'cover'}\" class=\"zmiti-createimg\" v-if=\"createImg\" _v-691fefda=\"\">\n\t\t\t\t<img :src=\"createImg\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t<div class=\"zmiti-border\" :class=\"{&quot;show&quot;:showBtns}\" _v-691fefda=\"\">\n\t\t\t\t\t<img :src=\"imgs.border\" _v-691fefda=\"\">\n\t\t\t\t</div>\n\t\t\t\t<div class=\"zmiti-border zmiti-border1\" :class=\"{&quot;show&quot;:showBtns}\" _v-691fefda=\"\">\n\t\t\t\t\t<img :src=\"imgs.border1\" _v-691fefda=\"\">\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t  </transition>\n\t\t<div v-show=\"!createImg\" class=\"lt-full\" ref=\"page\" _v-691fefda=\"\">\n\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t<div class=\"zmiti-index-main-content\" ref=\"zmiti-cache-page\" _v-691fefda=\"\">\n\t\t\t\t\t<section _v-691fefda=\"\">\n\t\t\t\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t\t\t\t<img :src=\"imgs.wx\" v-if=\"!showCollect\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t<p style=\"height: 1px;\" v-if=\"showCollect\" _v-691fefda=\"\"></p>\n\t\t\t\t\t\t\t<div :style=\"{width:'96%',background: 'url('+imgs.bg+') no-repeat center top',paddingTop:!showCollect?'2%':'2%',backgroundSize:'cover'}\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t<span _v-691fefda=\"\"></span>\n\t\t\t\t\t\t\t\t<div style=\"padding-top:4vh;\" _v-691fefda=\"\"></div>\n\t\t\t\t\t\t\t\t<div class=\"zmiti-brage\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t<img :src=\"imgs.brage\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"zmiti-haowai\" style=\"{{display:none}}\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t<img :src=\"imgs.haowai\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"zmiti-news-C\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t<h1 _v-691fefda=\"\">{{title}}</h1>\n\t\t\t\t\t\t\t\t\t<div class=\"zmiti-news\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\t<div v-for=\"c in newsContent\" _v-691fefda=\"\">{{c}}</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t<div class=\"zmiti-index-bottom\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t<img :src=\"imgs.bottom\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\n\t\t\t\t\t\t\t\t\t<div class=\"zmiti-copyright\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">{{date}}</div>\n\t\t\t\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">新华社</div>\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\t\t<img :src=\"imgs.logo\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\n\t\t\t\t\t</section>\n\n\t\t\t\t\t<div class=\"zmiti-qrcode\" _v-691fefda=\"\">\n\t\t\t\t\t\t<section _v-691fefda=\"\"> \n\t\t\t\t\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">我收藏了2018年两会号外</div>\n\t\t\t\t\t\t\t\t<div _v-691fefda=\"\">第{{periodsUpper[periods-1]}}期NO.{{randomPv}}号</div>\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t\t<div _v-691fefda=\"\">\n\t\t\t\t\t\t\t\t<img :src=\"imgs.qrcode\" @touchstart=\"starts\" _v-691fefda=\"\">\n\t\t\t\t\t\t\t</div>\n\t\t\t\t\t\t</section>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t<div class=\"wx-comments\" _v-691fefda=\"\">\n\t\t\t\t    <div class=\"wx-inner\" _v-691fefda=\"\">\n\t\t\t\t        <div class=\"comm-tips\" _v-691fefda=\"\">\n\t\t\t\t            <span _v-691fefda=\"\">评论墙</span>\n\t\t\t\t            <div class=\"clearfix\" _v-691fefda=\"\"></div>\n\t\t\t\t        </div>\n\t\t\t\t        <div class=\"wx-btn1\" _v-691fefda=\"\">\n\t\t\t                <span class=\"wx-btn-span\" @touchend=\"openDialog\" _v-691fefda=\"\">\n\t\t\t                    <span _v-691fefda=\"\">\n\t\t\t                        我要上墙\n\t\t\t                    </span>\n\t\t\t                    <i _v-691fefda=\"\"><img :src=\"imgs.edit\" alt=\"\" _v-691fefda=\"\"></i>\n\t\t\t                </span>\n\t\t\t\t        </div>\n\t\t\t\t        <div class=\"comm-inner\" _v-691fefda=\"\">\n\t\t\t\t            <ul id=\"wx-getmessagelist\" _v-691fefda=\"\">\n\t\t\t\t                <!--留言列表-->\n\t\t\t\t                <li v-for=\"(item,i) in commentList\" _v-691fefda=\"\">\n\t\t\t\t                \t\n\t\t\t\t                \t<div class=\"user-face\" _v-691fefda=\"\">\n\t\t\t\t                \t\t<img :src=\"imgs.logo\" _v-691fefda=\"\">\n\t\t\t\t                \t</div>\n\t\t\t\t                \t<div class=\"user-con\" _v-691fefda=\"\">\n\t\t\t\t                \t\t<div class=\"unames\" _v-691fefda=\"\">新华社网友\n\t\t\t\t                \t\t\t<div class=\"u-dz\" @touchend=\"like(item,i)\" _v-691fefda=\"\">\n\t\t\t\t                \t\t\t\t<i class=\"icon_praise_gray\" _v-691fefda=\"\">\n\t\t\t\t                \t\t\t\t\t<img :src=\"item.isLike?imgs.like1:imgs.like\" alt=\"\" _v-691fefda=\"\">\n\t\t\t\t                \t\t\t\t</i>\n\t\t\t\t                \t\t\t\t<span _v-691fefda=\"\">{{item.hymn}}</span>\n\t\t\t\t                \t\t\t\t<div class=\"zmiti-add\" :class=\"{'active':addIndex === i}\" _v-691fefda=\"\">+1</div>\n\t\t\t\t                \t\t\t</div>\n\t\t\t\t                \t\t</div>\n\t\t\t\t                \t\t<div class=\"utext\" _v-691fefda=\"\">{{item.content}}</div>\n\t\t\t\t                \t\t<div class=\"udates\" _v-691fefda=\"\">{{item.createtime}}</div>\n\t\t\t\t                \t</div>\n\t\t\t\t                </li>\n\t\t\t\t            </ul>\n\n\t\t\t\t            <div class=\"comm-tips\" _v-691fefda=\"\">\n\t\t\t\t                <span _v-691fefda=\"\">以上留言由新华社筛选后显示</span>\n\t\t\t\t                <div class=\"clearfix\" _v-691fefda=\"\"></div>\n\t\t\t\t            </div>\n\t\t\t\t            <div class=\"hr20\" _v-691fefda=\"\"></div>\n\t\t\t\t        </div>\n\t\t\t\t    </div>\n\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t\n\t\t</div>\n\n\t\t<!--message-dialog-->\n\t\t<div id=\"wx-message-dialog\" v-if=\"showDialog\" _v-691fefda=\"\">\n\t\t    <div class=\"wx-weui-mask\" _v-691fefda=\"\"></div>\n\t\t    <div class=\"wx-weui-dialog\" _v-691fefda=\"\">\n\t\t        <div class=\"wx-weui-title\" _v-691fefda=\"\">2018年两会号外</div>\n\n\t\t        <div class=\"wx-weui-textarea\" _v-691fefda=\"\">\n\t\t            <textarea v-model=\"content\" placeholder=\"\" _v-691fefda=\"\"></textarea>\n\t\t        </div>\n\t\t        <div class=\"wx-weui-btn2\" _v-691fefda=\"\">\n\t\t            <div class=\"wx-weui-submit\" v-tap=\"submitData\" _v-691fefda=\"\">提交</div>\n\t\t        </div>\n\t\t    </div>\n\t\t</div>\n\n\t\t <div v-if=\"showLoading\" class=\"zmiti-createimg-loading lt-full \" :style=\"{background: 'url('+imgs.bg+') no-repeat center top',backgroundSize:'cover'}\" _v-691fefda=\"\">\n\t\t \t \t<div class=\"loading\" _v-691fefda=\"\">\n\t\t \t \t\t<span _v-691fefda=\"\"></span>\n\t\t\t        <span _v-691fefda=\"\"></span>\n\t\t\t        <span _v-691fefda=\"\"></span>\n\t\t\t        <span _v-691fefda=\"\"></span>\n\t\t\t        <span _v-691fefda=\"\"></span>\n\t\t\t        <label _v-691fefda=\"\">正在生成号外...</label>\n\t\t \t \t</div>\n\t\t </div>\n\n\t\t <div class=\"zmiti-collect\" @touchstart=\"isPress = true\" @touchend=\"collect\" :class=\"{&quot;press&quot;:isPress}\" v-if=\"showCollect &amp;&amp; !createImg\" _v-691fefda=\"\">\n\t\t\t<img :src=\"imgs.collectBtn\" alt=\"\" _v-691fefda=\"\">\n\t\t\t<span _v-691fefda=\"\">点击收藏</span>\n\t\t</div>\n\t\t\n\t\t<div v-if=\"showBtns &amp;&amp; !src\" class=\"zmiti-share-btns\" _v-691fefda=\"\">\n\t\t\t<div @touchend=\"restart\" @touchstart=\"seePress = true\" _v-691fefda=\"\">\n\t\t\t\t<div :class=\"{&quot;press&quot;:seePress}\" class=\"\" _v-691fefda=\"\">\n\t\t\t\t\t<img :src=\"imgs.collectBtn\" _v-691fefda=\"\">\n\t\t\t\t\t<span _v-691fefda=\"\">\n\t\t\t\t\t\t我再看看\n\t\t\t\t\t</span>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t\t<div @touchend=\"showMask\" @touchstart=\"sharePress = true\" :class=\"{&quot;press&quot;:sharePress}\" _v-691fefda=\"\">\n\t\t\t\t<img :src=\"imgs.collectBtn\" _v-691fefda=\"\">\n\t\t\t\t<span _v-691fefda=\"\">\n\t\t\t\t\t分享\n\t\t\t\t</span>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div v-if=\"showBtns &amp;&amp; src\" class=\"zmiti-share-btns zmiti-share-btns1\" _v-691fefda=\"\">\n\t\t\t<div @touchend=\"restart\" @touchstart=\"seePress = true\" :class=\"{&quot;press&quot;:seePress}\" _v-691fefda=\"\">\n\t\t\t\t<img :src=\"imgs.collectBtn\" _v-691fefda=\"\">\n\t\t\t\t<span _v-691fefda=\"\">阅读新华社号外</span>\n\t\t\t</div>\n\t\t</div>\n\n\t\t<div v-if=\"showMasks\" @touchstart=\"hideMask\" class=\"zmiti-mask\" :style=\"{background: 'url('+imgs.arrow1+') no-repeat center top',backgroundSize:'cover'}\" _v-691fefda=\"\">\n\t\t\t\n\t\t</div>\n\n\t\t<toast :msg=\"toastMsg\" _v-691fefda=\"\"></toast>\n\t\t<audio src=\"./assets/music/1.mp3\" ref=\"audio\" _v-691fefda=\"\"></audio>\n\t</div>\n";
